...
@Component({
  selector: 'app-worker-tasks-dialog',
  templateUrl: './worker-tasks-dialog.component.html',
  styleUrl: './worker-tasks-dialog.component.css',
  standalone: true,
  imports: [
    MatTable,
    MatSort,
...
export class WorkerTasksDialogComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<WorkerTasksDialogComponent>,
